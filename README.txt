...
=II. Описание классов программы======================================================================================
Программа содержит четыре класса:
- AppRuner
- MyQueueDemo
- MyQueue
- MyException
...
выводит коллекции на экран, чтобы показать, что коллекция сместилась влево. Также в конце приведена демонстрация
блоков try, catch, finally с пробросом MyException в случае, если в очередь добавляется null.
...
Класс MyException наследует класс Exception.
